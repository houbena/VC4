...
void saveData(String toAddData){
...
//      }
  ...
  int resW;
    ...
    rectMode(CENTER);
    textSize(16);
    text("Average of all tests: " + nfc(readFileAndCalcAverage()/1000.0,1), screenW/2, 5*screenH/8, screenW, screenH);
    text("Your result: " + nfc(testScreen2.screenTime/1000.0,1), screenW/2, 6*screenH/8, screenW, screenH);
